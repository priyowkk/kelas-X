                        ...
                        <ul class="navbar-nav me-auto">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="produkDropdown">
                                    <li><a class="dropdown-item active" href="produk/pod_kategori.php">POD</a></li>
                    ...
                    <div class="filter-section sticky-top" style="top: 100px;">
                        ...
                        <div class="filter-group">
                            ...
                            <div class="form-check mb-2">
                                ...
                                <label class="form-check-label" for="vaporesso">Nano</label>
                            </div>
                            <div class="form-check mb-2">
                                <input class="form-check-input" type="checkbox" id="voopoo">
                                <label class="form-check-label" for="voopoo">Pro</label>
                            </div>
                            <div class="form-check mb-2">
                                <input class="form-check-input" type="checkbox" id="smok">
                                <label class="form-check-label" for="smok">Mini</label>
                            </div>
                        </div>

                        <div class="filter-group">
                            <h6>Price Range</h6>
                            <input type="range" class="form-range" min="150000" max="1000000" id="priceRange">
                        ...
                        <div class="filter-group">
                            ...
                            <div class="form-check mb-2">
                                <input class="form-check-input" type="checkbox" id="battery1">
                                <label class="form-check-label" for="battery1">800mAh - 1000mAh</label>
                            </div>
                            <div class="form-check mb-2">
                                <input class="form-check-input" type="checkbox" id="battery2">
                                <label class="form-check-label" for="battery2">1000mAh - 1500mAh</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="battery3">
                                <label class="form-check-label" for="battery3">1500mAh+</label>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-9">
                    <div class="row g-4">
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="card h-100">
                                <div class="card-img-wrapper">
                                    <img src="../images/XROS4.webp" class="card-img-top" alt="Xros 4">
                                ...
                                <div class="card-body">
                                    ...
                                    <h5 class="card-title">Vaporesso XROS 4</h5>
                                    <div class="product-specs">
                                        <p><i class="bi bi-battery-charging"></i>1000mAh Battery</p>
                                        <p><i class="bi bi-droplet-fill"></i>2ml Pod Capacity</p>
                                    </div>
                                    <div class="price mb-3">Rp 349.999</div>
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="card h-100">
                                <div class="card-img-wrapper">
                                    <img src="../images/nano4.webp" class="card-img-top" alt="Gen Max">
                                    <span class="badge-stock">In Stock</span>
                                </div>
                                <div class="card-body">
                                    <div class="product-rating">
                                    ...
                                    <h5 class="card-title">Vaporesso Xros Nano 4</h5>
                                    <div class="product-specs">
                                        <p><i class="bi bi-battery-charging"></i>1500mAh Battery</p>
                                        <p><i class="bi bi-droplet-fill"></i>3ml Pod Capacity</p>
                                    </div>
                                    <div class="price mb-3">Rp 349.999</div>
                                    <button class="btn btn-primary w-100">Add to Cart</button>
                                </div>
